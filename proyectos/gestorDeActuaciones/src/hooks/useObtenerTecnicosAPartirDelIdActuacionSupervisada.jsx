...
// Mi Hook
const useObtenerTecnicosAPartirDelIdActuacionSupervisada = (idActuacion) => {
        ...
        if (sesion) {
            ...
            const obtenerTecnicos = async () => {
                ...
                try {
                    ...
                    const documento = await getDoc(doc(db, 'actuacionesSupervisadas', idActuacion));
...
export default useObtenerTecnicosAPartirDelIdActuacionSupervisada;
