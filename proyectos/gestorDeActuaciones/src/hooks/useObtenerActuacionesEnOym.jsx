...
// Hook
const useObtenerActuacionesEnOym = () => {

    // Estados
	const {sesion} = useAuth();	
	const [actuacionesEnOym, asignarActuacionesEnOym] = useState([]);
	...
	return [actuacionesEnOym];
}

export default useObtenerActuacionesEnOym;