...
// Hook
const useTecnicosCitados = () => {

    // Estados
	const {sesion} = useAuth();	
	const [tecnicosCitados, setTecnicosEnCitados] = useState([]);
	...
	useEffect(() => {
		...
		if (sesion) {			
			...
			const unsuscribe = onSnapshot(consulta, (snapshot) => {
				setTecnicosEnCitados(snapshot.docs.map((documento) => {
	...
	return [tecnicosCitados];
}

export default useTecnicosCitados;