...
const  FormularioEditarActuacionTecnico = () => {
    ...
    /*  Obtengo los acompañantes filtrando a todos los tecnicos obtenidos por el hook
        eliminandole quien inico la sesion guardado en nombre */
    let acompañantes = []; 
    ...
    // Efecto para obtener la informacion inicial
    useEffect(() => {           
