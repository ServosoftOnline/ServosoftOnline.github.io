...
// Componente
const DatePicker = ({fechaCitacion, asignarFechaCitacion}) => {
    ...
    return (
        ...
        <ContenedorInput>
            ...
            <input onClick={() => cambiarMostrarCalendario(!mostrarCalendario)}
                type ="text"
                readOnly
                value={format(fechaCitacion, `dd 'de' MMMM 'de' yyyy`, {locale: es})}                
            />
